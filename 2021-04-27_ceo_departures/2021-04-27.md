...
The data this week comes from Gentry et al. (2021) by way of
DataIsPlural.
...
**Could there be something to explore about timing vis-a-vis
recessions?**
...
![](2021-04-27_files/figure-gfm/departure_names-1.png)<!-- --> \# What
reasons are companies changing CEO ?
...
These don’t look like they line up with the dismissal attribute of these
observations. There are 1497 dismissals in the departure reasons list,
but only 1471 in the ceo\_dismissal list. \# Fix these numbers.
...
These entries probably need review. Most of them should probably have
their ceo\_dismissal value changed to ‘1’ from ‘0.’
