...
parks %>%
  ...
  mutate(
    `2019to2020` = `2020`- `2019`,
    `2018to2019` = `2019`- `2018`,
    `2017to2018` = `2018`- `2017`,
    `2016to2017` = `2017`- `2016`,
    `2015to2016` = `2016`- `2015`,
    `2014to2015` = `2015`- `2014`,
    `2013to2014` = `2014`- `2013`,
    `2012to2013` = `2013`- `2012`,
    total_variation_over_time = 
           abs(`2020` - `2019`) + 
           abs(`2019` - `2018`) +
           abs(`2018` - `2017`) +
           abs(`2017` - `2016`) +
           ...
           abs(`2014` - `2013`) +
           abs(`2013` - `2012`)) %>%
  arrange(desc(total_variation_over_time)) %>%
  ggplot(aes(x = city, y = total_variation_over_time)) +
    geom_col() +
    coord_flip()
```
