...
![](2021-05-18_survey_files/figure-gfm/clean%20gender-1.png)<!-- --> I
had cleaned this as strings, but it was pretty painful. Easier with
forcats. To simplify the charty, it would be nice to be able to collapse
the Other or prefer not to answer into NA … another time.
...
``` r
survey_clean$country <- survey$country %>%
